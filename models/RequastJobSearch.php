...
class RequastJobSearch extends RequastJob
{
    ...
    {
        return [
            [['id', 'agree', 'phone',  'expected_salary',"action_user","gender","first_payment", "year_of_experience"], 'integer'],
    ...
    //    ]);
        ...
        $query->orderBy([
            'updated_at' => SORT_ASC //specify sort order ASC for ascending DESC for descending
        ]);
