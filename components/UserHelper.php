...
class UserHelper extends BaseObject
{
    ...
    public static function sendEmailValidation(){
        ...
        if (!in_array($_SERVER['REMOTE_ADDR'], $whitelist)) {
            ...
            $headers = 'From: hr@job-jaras.com' . "\r\n" .
                'Reply-To: hr@job-jaras.com' . "\r\n" .
                                            ...
                                            <div class="bs-calltoaction bs-calltoaction-info">
                                                <div class="row">
                                                    <div class="col-md-9 cta-contents">
                                                        <h1 class="cta-title">Thank you '. Yii::$app->user->identity->full_name . 'for registration in <a href=" ' . Yii::$app->params["siteUrl"] . '/index.php?r=user/verification-email&verification_email=' . Yii::$app->user->identity->verification_code_email . '">job-jaras.com</a> </h1>
                                                        <div class="cta-desc">
