                ...
                <div class="panel-body">
                    <div class="row">
                      <div class="col-md-4">
                        ...
                        <div class="feedback">
                          <div class="rating">
                            <input type="radio" name="rating" user_id="<?=$model->user->id?>" id="rating-5"  value="5">
                            <label for="rating-5"></label>
                            <input type="radio" name="rating" user_id="<?=$model->user->id?>" id="rating-4" value="4">
                            <label for="rating-4"></label>
                            <input type="radio" name="rating" user_id="<?=$model->user->id?>" id="rating-3" value="3">
                            <label for="rating-3"></label>
                            <input type="radio" name="rating" user_id="<?=$model->user->id?>" id="rating-2" value="2">
                            <label for="rating-2"></label>
                            <input type="radio" name="rating"  user_id="<?=$model->user->id?>" id="rating-1" value="1">
